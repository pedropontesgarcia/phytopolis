...
public class ParserUtils {
    ...
    public static String safeConcatenate(String first,
                                         String second,
                                         char sep,
                                         char alt) {
     ...
     */
    public static FreeTypeFontGenerator.Hinting parseHinting(JsonValue json,
                                                             FreeTypeFontGenerator.Hinting defaultHinting) {
        ...
        if (json == null) {
            ...
            if (code != null && code.length() > 0) {
                if (code.charAt(0) == '#') {
                    ...
                    try {
                        return (Color) Color.class.getField(code.toUpperCase())
                                .get(null);
                    } catch (Exception e) {
                    }
                }
     ...
     */
    public static Texture.TextureFilter parseFilter(JsonValue json,
                                                    Texture.TextureFilter defaultFilter) {
        if (json == null || json.asString() == null) {
     ...
     */
    public static Texture.TextureWrap parseWrap(JsonValue json,
                                                Texture.TextureWrap defaultWrap) {
        if (json == null || json.asString() == null) {
            return defaultWrap;
        }
