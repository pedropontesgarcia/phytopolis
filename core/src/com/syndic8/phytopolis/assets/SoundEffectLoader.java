...
public class SoundEffectLoader
        extends AsynchronousAssetLoader<SoundEffect, SoundEffectLoader.SoundEffectParameters> {
    ...
    public void loadAsync(AssetManager manager,
                          String fileName,
                          FileHandle file,
                          SoundEffectParameters params) {
        AudioSource source = manager.get(manager.getDependencies(fileName)
                                                 .first(), AudioSource.class);
     ...
     */
    @Override
    public SoundEffect loadSync(AssetManager manager,
                                String fileName,
                                FileHandle file,
                                SoundEffectParameters params) {
    ...
    public FileHandle resolve(String fileName) {
        ...
        if (suffix == -1) {
            throw new GdxRuntimeException(
                    "Sound buffer file name must end in ':alias'.");
        }
    ...
    public Array<AssetDescriptor> getDependencies(String fileName,
        ...
        deps.add(new AssetDescriptor<AudioSource>(params.source,
                                                  AudioSource.class));
        return deps;
    }
     ...
     */
    static public class SoundEffectParameters
