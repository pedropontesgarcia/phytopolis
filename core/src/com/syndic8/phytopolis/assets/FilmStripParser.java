...
public class FilmStripParser implements AssetParser<FilmStrip> {
    ...
    public void processNext(AssetManager manager,
        ...
        FilmStripLoader.FilmStripParameters params = new FilmStripLoader.FilmStripParameters(
                file);
        ...
        String region = ParserUtils.safeConcatenate(file,
                                                    sprite.name(),
                                                    ALIAS_SEP,
                                                    ALIAS_MASK);
