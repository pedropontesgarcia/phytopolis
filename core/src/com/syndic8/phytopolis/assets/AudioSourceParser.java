/*
 * AudioSourceParser.java
 *
 * This is an interface for parsing a JSON entry into a AudioSource asset. AudioSource
...
/**
 * This class parses a JSON entry into a {@link AudioSource} object.
 * <p>
 * Sound assets do not have any properties other than the file name, due to
 * the limitations of LibGDX audio.
 */
public class AudioSourceParser implements AssetParser<AudioSource> {
     ...
     */
    public Class<AudioSource> getType() {
    ...
    public void processNext(AssetManager manager,
        ...
        manager.load(file, AudioSource.class, null);
        root = root.next();
    }
    ...
    public boolean equals(Object o) {
        return o instanceof AudioSourceParser;
    }
