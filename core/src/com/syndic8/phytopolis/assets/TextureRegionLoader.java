...
public class TextureRegionLoader
        extends AsynchronousAssetLoader<TextureRegion, TextureRegionLoader.TextureRegionParameters> {
    ...
    public void loadAsync(AssetManager manager,
                          String fileName,
                          FileHandle file,
                          TextureRegionParameters params) {
     ...
     */
    @Override
    public TextureRegion loadSync(AssetManager manager,
                                  String fileName,
                                  FileHandle file,
                                  TextureRegionParameters params) {
    ...
    public TextureRegion load(Texture texture, TextureRegionParameters params) {
        ...
        int width =
                params.width < 0 ? texture.getWidth() - params.x : params.width;
        int height = params.height < 0 ?
    ...
    public FileHandle resolve(String fileName) {
        ...
        if (suffix == -1) {
            throw new GdxRuntimeException(
                    "Texture region file name must end in ':name'.");
        }
