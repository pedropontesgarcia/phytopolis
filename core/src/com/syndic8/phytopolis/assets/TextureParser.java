...
public class TextureParser implements AssetParser<Texture> {
    ...
    public void processNext(AssetManager manager,
        ...
        if (root.isString()) {
            ...
            params.minFilter = ParserUtils.parseFilter(root.get("minFilter"),
                                                       Texture.TextureFilter.Linear);
            params.magFilter = ParserUtils.parseFilter(root.get("magFilter"),
                                                       Texture.TextureFilter.Linear);
            params.wrapU = ParserUtils.parseWrap(root.get("wrapU"),
                                                 Texture.TextureWrap.ClampToEdge);
            params.wrapV = ParserUtils.parseWrap(root.get("wrapV"),
                                                 Texture.TextureWrap.ClampToEdge);
            params.format = root.getBoolean("alpha", true) ?
