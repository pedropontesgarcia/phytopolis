...
public abstract class CapsuleObject extends GameObject {
     ...
     */
    public CapsuleObject(float width, float height) {
     ...
     * @param height	The object width in physics units
     */
    public CapsuleObject(float x, float y, float width, float height) {
     ...
     * @param height	The object width in physics units
     */
    public CapsuleObject(float x, float y, float width, float height, Orientation o) {
        super(x,y);
