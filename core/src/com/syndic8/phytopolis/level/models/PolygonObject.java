...
import com.syndic8.phytopolis.GameCanvas;  // For GameCanvas
...
public class PolygonObject extends GameObject {
     ...
     */
    public PolygonObject(float[] points, float x, float y) {
        super(x, y);
    ...
    /**
     * Creates a body for the obstacle and returns it
     * @param world The game world
     * @return a body for the obstacle
     */
    public Body getBody(World world){
        return world.createBody(bodyinfo);
    }
