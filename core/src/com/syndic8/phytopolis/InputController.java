...
public class InputController {
    ...
    public float getGrowX(){return growX;}

    public float getGrowY(){return growY;}
    ...
    private void readKeyboard(Rectangle bounds, Vector2 scale, boolean secondary) {
        ...
        debugPressed =
                (secondary && debugPressed) || (Gdx.input.isKeyPressed(Input.Keys.K));
        primePressed =
                (secondary && primePressed) || (Gdx.input.isKeyPressed(Input.Keys.W));
